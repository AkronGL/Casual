  ...
  <div class="mdui-list" mdui-collapse="{accordion: true}" style="margin-bottom: 76px;">
    ...
    <div class="mdui-collapse-item ">
      ...
      <div class="mdui-collapse-item-body mdui-list">
        ...
        <a href="./manage-comments.php" class="mdui-list-item mdui-ripple ">管理文件</a>
	...
	<div class="mdui-collapse-item ">
      ...
      <div class="mdui-collapse-item-body mdui-list">
        ...
        <a onclick="notice();" class="mdui-list-item mdui-ripple">T-AdminTheme公告</a>
      </div>
      <script type="text/javascript">
        function notice() {
            mdui.dialog({
                title: 'T-AdminTheme公告',
                content: '本模板当前版本:Vesion1.2<br>开发者:Magneto<br>开源地址：<a href="https://gitee.com/Magnetokuwan/T-AdminTheme" target="_blank">Gitee</a>，<a href="https://github.com/ouyangyanhuo/T-AdminTheme" target="_blank">GitHub</a>',
                buttons: [
                    {
                        text: '我知道了'
                    }
